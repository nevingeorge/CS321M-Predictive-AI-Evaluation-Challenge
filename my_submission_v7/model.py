...
import os
# Block all outbound HuggingFace network calls before any HF library is imported.
# Without this the libraries try to check for model updates, which the platform blocks,
# causing those calls to hang until the 10-second per-call timeout is hit.
